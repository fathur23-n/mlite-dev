...
public function postDeleteStudy()
{
  ...
  public function getEncounterBundle($no_rawat, $param = '')
  {
    ...
    // Billing — pakai tabel billing, ambil tgl_byr terbaru
    ...
    foreach ((array)$entry as $key => $value) {
        ...
        if ($resourceType == 'ServiceRequest')     { $id_service_request_lab    = $value->response->resourceID; }
        if ($resourceType == 'Specimen')           { $id_specimen_lab           = $value->response->resourceID; }
        if ($resourceType == 'DiagnosticReport')   { $id_diagnostic_report_lab  = $value->response->resourceID; }
    ...
    $result = [
        ...
        'resources' => [
            ...
            ['label' => 'Condition (Diagnosa)',  'id' => $id_condition,              'sent' => !empty($id_condition)],
